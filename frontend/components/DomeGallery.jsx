...
export default function DomeGallery({
  ...
  const resolvedOverlayBlurColor = useMemo(
    () => resolveCssColor(overlayBlurColor),
    [overlayBlurColor]
  );
  ...
  useEffect(() => {
    ...
    const ro = new ResizeObserver(entries => {
      ...
      root.style.setProperty('--overlay-blur-color', resolvedOverlayBlurColor);
    ...
    <>
      ...
      <div
        ...
        style={{
          ['--segments-x']: segments,
          ['--segments-y']: segments,
          ['--overlay-blur-color']: resolvedOverlayBlurColor,
        ...
        <main
          ...
          <div
            ...
            style={{
              backgroundImage: `radial-gradient(rgba(235, 235, 235, 0) 65%, var(--overlay-blur-color, ${resolvedOverlayBlurColor}) 100%)`
            }} />

          <div
            className="absolute inset-0 m-auto z-3 pointer-events-none"
            style={{
              WebkitMaskImage: `radial-gradient(rgba(235, 235, 235, 0) 70%, var(--overlay-blur-color, ${resolvedOverlayBlurColor}) 90%)`,
              maskImage: `radial-gradient(rgba(235, 235, 235, 0) 70%, var(--overlay-blur-color, ${resolvedOverlayBlurColor}) 90%)`,
          ...
          <div
            ...
            style={{
              background: `linear-gradient(to bottom, transparent, var(--overlay-blur-color, ${resolvedOverlayBlurColor}))`
            }} />
          <div
